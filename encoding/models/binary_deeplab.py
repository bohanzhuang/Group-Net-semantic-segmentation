...
from .new_layers import group_conv
...
class DeepLabV3(BaseNet):
    def __init__(self, nclass, backbone, aux=True, se_loss=False, norm_layer=nn.BatchNorm2d, **kwargs):
        ...
        print('%s' % (backbone))
        if backbone == 'resnet18' or backbone == 'resnet34' or backbone == 'binary_resnet18' or backbone == 'binary_resnet34' or backbone == 'binary_resnet18_dilated' or backbone == 'binary_resnet34_dilated':
            self.head = DeepLabV3Head(512, nclass, norm_layer, self._up_kwargs)
        else: 
...
def get_binary_deeplab(dataset='pascal_voc', backbone='resnet50', pretrained=False,
